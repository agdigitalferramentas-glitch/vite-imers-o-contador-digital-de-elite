...
const CTA_LABEL = "QUERO CAPTURAR ESSA RECEITA POR R$ 27";
        ...
        <div className="mx-auto w-full max-w-6xl">
          <div className="lg:w-1/2">
            ...
            <h1 className="text-balance text-2xl leading-[1.12] md:text-3xl lg:text-[2.35rem]">
              Você já tem os clientes. O dinheiro que falta está <span className="gold-text">dentro da sua própria carteira.</span>
            </h1>
            ...
            <div className="mt-5 flex flex-col items-start gap-4">
              ...
              <p className="text-xs text-white/60">
                Pagamento 100% seguro via Kiwify. Uma única vez. Sem mensalidade.
              </p>
              <div className="flex flex-row flex-wrap justify-start gap-x-4 gap-y-2 text-sm text-white/70 md:flex-col md:items-start md:gap-2 md:justify-start">
                <span className="flex items-center gap-2"><Users size={16} className="shrink-0 text-[var(--gold)]" /> +1.200 clientes ativos</span>
                <span className="flex items-center gap-2"><TrendingUp size={16} className="shrink-0 text-[var(--gold)]" /> 40% margem líquida</span>
                <span className="flex items-center gap-2"><BookOpen size={16} className="shrink-0 text-[var(--gold)]" /> +2.500 alunos formados</span>
              </div>
            </div>
          </div>
        </div>
